...
function ExperienceCard({ exp, align }) {
  ...
  return (
    <motion.article
      ...
      className={[
        "bg-gray-800 text-white border border-gray-700 rounded-xl p-6 shadow-md hover:shadow-xl transition-all",
        alignClass,
      ].join(" ")}
    >
